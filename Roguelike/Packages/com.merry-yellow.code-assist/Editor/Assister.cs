...
namespace Meryel.UnityCodeAssist.Editor
{
    public class Assister
    {
        ...
        static void Upgrade()
        {
...
#if MERYEL_UCA_LITE_VERSION
            UnityEngine.Debug.LogWarning("Purchase <a href=\"http://u3d.as/2N2H\">'Code Assist'</a> from the asset store and download it from the package manager first");
            return;
#else
            ...
            {
                UnityEngine.Debug.LogWarning($"Installer for Visual Studio couldn't be found at {vsixPath}. Please try re-importing the asset from the package manager");
                return;
            }
